...
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Your website deserves to look pixel-perfect on every device. concealednation2024 ensures your entire design scales down gracefully automagically.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">We obsess over performance so you don't have to. concealednation2024 is super lightweight and scores top marks on Google PageSpeed Insights.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Creating unique designs has never been easier. concealednation2024's growing pattern library puts expertly designed patterns at your fingertips.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">concealednation2024 launches with built-in pattern designs, page templates, style variations and more so you can get your site launched quickly.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
