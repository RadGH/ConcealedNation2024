 ...
 * Description:
 * Categories: concealednation2024/pricing
...
<p class="has-text-align-center">Easily create beautiful and responsive pricing tables with concealednation2024 patterns. Connect your eCommerce solution and start making bank.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/avatar-2.webp" alt="" class="wp-image-57" style="width:60px;height:60px" width="60" height="60"/></figure>
<!-- /wp:image -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Now that I’ve seen how powerful the Site Editor can be, I can't live without it. concealednation2024 made it super easy to get started with the “new” WordPress.</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/avatar-7.webp" alt="" class="wp-image-62" style="width:60px;height:60px" width="60" height="60"/></figure>
<!-- /wp:image -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">I finally feel like I can ditch my costly page builder plugin. Now, I can quickly build out page sections or full page designs with concealednation2024 patterns. </p>
<!-- /wp:paragraph -->
