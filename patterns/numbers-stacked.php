...
<p class="has-primary-accent-color has-text-color">concealednation2024 ships with over 50 pixel-perfect pattern designs you can use to build a stunning website with a few clicks.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"textColor":"primary-accent"} -->
<p class="has-primary-accent-color has-text-color">concealednation2024 ships with several full page designs such as Homepage, About, Features, Download, and more.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:paragraph {"textColor":"primary-accent"} -->
<p class="has-primary-accent-color has-text-color">We've spent thousands of hours crafting WordPress themes and applied everything we know to concealednation2024.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"textColor":"primary-accent"} -->
<p class="has-primary-accent-color has-text-color">concealednation2024 boasts over two hundred 5 star reviews and an average rating of 9 on Rotten Tomatoes.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
